...
//
//     final itemCommentsModel = itemCommentsModelFromJson(jsonString);

import 'dart:convert';

ItemCommentsModel itemCommentsModelFromJson(String str) => ItemCommentsModel.fromJson(json.decode(str));

String itemCommentsModelToJson(ItemCommentsModel data) => json.encode(data.toJson());
...
class ItemCommentsModel {
  ...
  factory ItemCommentsModel.fromJson(Map<String, dynamic> json) => ItemCommentsModel(
