...
import 'package:merchant/data/model/Attachment.dart'; // Make sure you import the model

// Global list to store demo attachments
List<Attachment> demoAttachments = [];

class BodyAttachments extends StatefulWidget {
  const BodyAttachments({super.key});
                ...
                children: <Widget>[
                  ...
                  CustomButton(
                    ...
                    press: () async {
                      ...
                      demoAttachments.add(newAttachment);
